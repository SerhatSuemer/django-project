...
def artikelBackend(request):
    ...
    if action == 'bestellen':
        ...
        messages.success(request, "Artikel wurde zum Warenkob hinzugefügt.")
    elif action == 'entfernen':
        bestellteArtikel.menge = (bestellteArtikel.menge - 1)
        messages.warning(request, "Artikel wurde aus dem Warenkob entfernt.")   
...
def bestellen(request):
    ...
    paypal_dict = {
    "business": "sb-qyxb214362763@business.example.com",
    "amount": gesamtpreis,
    "item_name": "",
    "invoice": auftrags_id,
    "currency_code": "EUR",
